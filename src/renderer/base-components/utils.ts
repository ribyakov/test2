 ...
 */
export function normalizeInput(value: string, sep = SEPARATOR) {
 ...
 */
export function validateDD(value: string) {
 ...
 */
export function validateDMS(value: string) {
 ...
 */
export function parseDMS(value: string, sep = SEPARATOR) {
  // @ts-ignore
 ...
 */
export function decimalToDMS(dd: number, isLon: boolean, precision = 0) {
  const factor = Math.pow(10, precision);
